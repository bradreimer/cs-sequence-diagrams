...
{
	/// <summary>
	/// Provides a control for drawing sequence diagrams described by a <see cref="SequenceDiagramViewModel"/> 
	/// </summary>
	internal class SequenceDiagramCanvas : Control
	{
		#region Members
		...
		static SequenceDiagramCanvas()
		{
			DefaultStyleKeyProperty.OverrideMetadata(typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(typeof(SequenceDiagramCanvas)));
		}
		...
		public static readonly DependencyProperty ContentProperty =
			DependencyProperty.Register(nameof(Content), typeof(SequenceDiagramViewModel), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(null,
					FrameworkPropertyMetadataOptions.AffectsRender |
					FrameworkPropertyMetadataOptions.AffectsMeasure));

		public static readonly DependencyProperty DrawingStyleProperty =
			DependencyProperty.Register(nameof(DrawingStyle), typeof(SequenceDrawingStyle), typeof(SequenceDiagramCanvas),
		...
		public static readonly DependencyProperty ActorForegroundProperty =
			DependencyProperty.Register(nameof(ActorForeground), typeof(Brush), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(Brushes.Black,
					FrameworkPropertyMetadataOptions.AffectsRender));

		public static readonly DependencyProperty ActorBackgroundProperty =
			DependencyProperty.Register(nameof(ActorBackground), typeof(Brush), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(Brushes.White,
					FrameworkPropertyMetadataOptions.AffectsRender));

		public static readonly DependencyProperty SignalForegroundProperty =
			DependencyProperty.Register(nameof(SignalForeground), typeof(Brush), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(Brushes.Black,
					FrameworkPropertyMetadataOptions.AffectsRender));

		public static readonly DependencyProperty NoteForegroundProperty =
			DependencyProperty.Register(nameof(NoteForeground), typeof(Brush), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(Brushes.Black,
					FrameworkPropertyMetadataOptions.AffectsRender));

		public static readonly DependencyProperty NoteBackgroundProperty =
			DependencyProperty.Register(nameof(NoteBackground), typeof(Brush), typeof(SequenceDiagramCanvas),
				new FrameworkPropertyMetadata(Brushes.White,
					FrameworkPropertyMetadataOptions.AffectsRender));
		...
		/// </summary>
		public SequenceDiagramViewModel Content
		{
			get { return (SequenceDiagramViewModel)GetValue(ContentProperty); }
		...
		private IDrawingCanvas CreateDrawingCanvas(DrawingContext drawingContext)
		{
			switch (DrawingStyle)
			{
				case SequenceDrawingStyle.Default:
					return new DefaultDrawingCanvas(drawingContext, Foreground);
				case SequenceDrawingStyle.HandDrawn:
